...
import com.example.domains.contracts.repositories.PaymentsRepository;
import com.example.domains.contracts.services.PaymentsService;
...
public class PaymentsServiceImpl implements PaymentsService {
	private PaymentsRepository dao;
	
	public PaymentsServiceImpl(PaymentsRepository dao) {
		this.dao = dao;
	}
