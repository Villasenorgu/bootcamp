...
import com.example.domains.contracts.repositories.PedidosRepository;
...
class PedidoServiceImplTest {
	List<Rental> listado;
	PedidosRepository dao;
	
	@BeforeEach
	void setUp() throws Exception {
        DateFormat df1 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
        Date result1 = df1.parse("2001-07-04T12:08:56.235-0700");
        ...
        dao = mock(PedidosRepository.class);
    }

	@Test
	void testGetAll() {
		when(dao.findAll()).thenReturn(listado);
		var srv = new PedidosServiceImpl(dao);
